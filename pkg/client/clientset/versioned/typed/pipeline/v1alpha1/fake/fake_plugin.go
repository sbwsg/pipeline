...
var pluginsResource = schema.GroupVersionResource{Group: "tekton.dev", Version: "v1alpha1", Resource: "plugins"}

var pluginsKind = schema.GroupVersionKind{Group: "tekton.dev", Version: "v1alpha1", Kind: "Plugin"}
